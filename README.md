...
- Maze: static layouts  
- Collectible: required item to complete each level  
- Enemy: movement, collision, damage system  
- UI: menu and level selection  

---

## Initial Personal Goals 

- Zach: set up player controls, movement, and physics
- Miranda: write enemy AI, set up enemy collisions and movement
- Ivan: set up maze for first level 
